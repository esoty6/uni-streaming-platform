    ...
    <div class="register"><bR><bR>
        <div class="container-fluid d-flex justify-content-center my-3 " id="zmiana">
            <div class="flex-row w-50">
                <form class="col-12" name="dodaj" id="addForm" method="post" action="addWorker.php">
                    <label>Imie:</label>
                    ...
                    <div class="przycisk">
                        <button class="btn" name="submit" type="submit" id="dodajbutton">Dodaj pracownika</button>
                    </div>
                </form>
            </div>
        </div>
